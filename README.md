...
- 🔭 Focused on **SOC operations, threat hunting & detection engineering**
- 🏗️ I build hands-on home labs — SIEM deployments, honeypots, Active Directory, WAFs
...
|---|---|---|
| 🍯 [azure-honeypot-sentinel-soc](https://github.com/anmoldarve/azure-honeypot-sentinel-soc) | Exposed Windows VM in Azure capturing real internet attacks, centralised into Sentinel with geo-enrichment and attack maps | `Azure` `Sentinel` `KQL` |
| 🕵️ [soc-account-compromise-investigation](https://github.com/anmoldarve/soc-account-compromise-investigation) | Tier 1→3 investigation across 932 enterprise log events — behavioural baselining and anomaly hunting in KQL, no pre-labelled data | `Azure Data Explorer` `KQL` |
| 📊 [sysmon-splunk-monitoring](https://github.com/anmoldarve/sysmon-splunk-monitoring) | Sysmon endpoint telemetry piped into Splunk Enterprise from a Windows Server DC — deployment, ingestion and search | `Sysmon` `Splunk` |
| 🐺 [wazuh-siem-xdr](https://github.com/anmoldarve/wazuh-siem-xdr) | Open-source SIEM/XDR deployment — file integrity monitoring, auth monitoring and vulnerability detection across Linux + Windows agents | `Wazuh` `Ubuntu` |
| ☁️ [enterprise-azure-security-monitoring](https://github.com/anmoldarve/enterprise-azure-security-monitoring) | Enterprise-scale security monitoring design in Azure | `Azure` |
| 🛰️ [elastic-siem-homelab](https://github.com/anmoldarve/elastic-siem-homelab-main) | SIEM homelab for hands-on threat detection | `Elastic` |
| 🔐 [SSH-Brute-Force-Detection-Splunk](https://github.com/anmoldarve/SSH-Brute-Force-Detection-Splunk-main) | Detecting SSH brute-force attacks through Splunk log analysis | `Splunk` |
| 📡 [wireshark-beaconing-analysis](https://github.com/anmoldarve/wireshark-beaconing-analysis) | Identifying C2 beaconing patterns in network traffic | `Wireshark` |
| 🧾 [End-to-End-SOC-Investigation-Simulation](https://github.com/anmoldarve/End-to-End-SOC-Investigation-Simulation-) | Full investigation walkthrough, from first alert to root cause | `SOC` |
...
| Project | What it is | Stack |
|---|---|---|
| 🖥️ [Active-Directory-Lab](https://github.com/anmoldarve/Active-Directory-Lab) | Windows Server AD lab — AD DS, DNS, DHCP, Group Policy and a segmented Cisco network design | `Windows Server` `PowerShell` |
...
| Project | What it is | Stack |
|---|---|---|
| 📜 [custom-log-intrusion-detection-system](https://github.com/anmoldarve/custom-log---intrusion-detection-system-ids-main) | Log-based intrusion detection system built from scratch | `Python` |
| ⚖️ [OWASP-Risk-Enumerator](https://github.com/anmoldarve/OWASP-Risk-Enumerator-main) | UI tool that scores risk using OWASP risk rating factors | `HTML` |
| 🔌 [port-scanner-V1](https://github.com/anmoldarve/port-scanner-V1--main) | Lightweight TCP port scanner using the Python stdlib | `Python` |
